...
"syn match cuplsimMacro "#.*" containedin=ALL
"syn match cuplsimMacro "#macro.*" 
"syn match cuplsimMacro "#def_macro.*"
"syn match cuplsimMacro "#end_macro.*"
"syn match cuplsimMacro "#set.*"
"syn match cuplsimMacro "#gen_vector.*"
"syn match cuplsimMacro "#field_size.*"
syn match cuplComment "//.*"
syn match cuplsimMacro /#[^ ]\+/ contained
syn region cuplsimMacroLine start=/#[^ ]\+/ end=/$/ contains=cuplsimMacro,cuplComment
syn match cuplsimMsg /#msg/ contained
syn region cuplsimMsgLine start=/#msg/ end=/$/ contains=cuplsimMsg
syn match cuplComment "#//.*"
...
hi cuplsimMacro	ctermfg=Cyan
hi def link cuplsimMacroLine Normal
hi cuplsimMsg	ctermfg=Cyan
hi def link cuplsimMsgLine cuplString
